...
# =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-
# touch test.{mkv,psd,reg,rar,msi,o,rtf,xml,xpi,sh,c,avi,cab,gif,java,js,h,txt,md,mov,mp3,mp4,zip,zsh,rb,fish,tar,tgz,flv,a,out,css,scss,html,php,iso,ini,vim,exe,png,xls,doc,docx,deb,dot,eps,dmg,py,qt,ps,ppt,vob,jar,jpeg,bmp,bz2,class,csh,bat,org,gz,swp,bin,tiff,pcx,pps,com,cmd,7z,cc,svg,eps,swf}
